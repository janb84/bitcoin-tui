...
- **Tools** - broadcast raw transactions via `sendrawtransaction` (`[b]`); broadcast PSBTs via `finalizepsbt` + `sendrawtransaction` (`[p]`); live private broadcast queue (Bitcoin Core PR #29415, shown when non-empty)
