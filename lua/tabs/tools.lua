...
----------------------------------------------------------------------
-- Panels (created once at load; populated by update_*_panel / refresh)
----------------------------------------------------------------------
...
local function update_shutdown_panel()
...
local function update_broadcast_panel()
    ...
    if bstatus == nil then
        info_row(broadcast_panel, "help1", "Broadcast a raw transaction to the network")
