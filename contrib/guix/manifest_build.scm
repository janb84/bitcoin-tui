...
desirable for building Bitcoin-tui release binaries."
...
(define-public glibc-2.31
  (package
    ...
    (source (origin
              (method url-fetch)
              (uri (string-append "mirror://gnu/libc/glibc-2.31.tar.xz"))
              (sha256
               (base32
    ...
    ((#:phases phases)
        `(modify-phases ,phases
           (add-before 'configure 'limit-optimization
             (lambda _
               ;; GCC 14 spends hours on stdio-common/vfprintf.c at -O2 when
               ;; cross-compiling for aarch64. Patch Makeconfig directly since
               ;; glibc ignores the CFLAGS env var.
...
(packages->manifest
 (append
  (list ;; The Basics
        ...
        cmake-minimal
        gnu-make
        ;; Kernel headers (needed to compile Catch2 benchmarks)
